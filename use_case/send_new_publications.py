class SendNewPublications:
    def __init__(self, my_logger, last_entry_service, twitter_publication_service, blog_publication_service, last_entry_datetimes, telegram_notifier_service, blog_board_message_publication_service, last_board_message_service, last_board_message):
        ...
        self._last_board_message = last_board_message
    ...
    def send(self):
        ...
        last_board_message, new_board_message_publications = self._blog_board_message_publication_service.get_new_publications(self._last_board_message)
